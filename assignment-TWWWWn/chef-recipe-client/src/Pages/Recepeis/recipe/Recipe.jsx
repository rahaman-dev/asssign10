...
const Recipe = ({ nr }) => {
  ...
  return (
    ...
    >
      <img
        style={{ width: "480px", height: "", padding: "10px", borderRadius: "10px" }}
        src={banner}
        alt="Chef Picture"
      ...
      <div style={{ marginLeft: "10px", lineHeight: "27px" }}>
        ...
        <button onClick={handleFavoriteBtn} style={{ border: "none" }}>
          <svg
            className="svg-icon border"
            viewBox="0 0 20 20"
            style={{ fontSize: "20px" }}
          >
